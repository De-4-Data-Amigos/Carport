...
class UserMapperTest
{
    ...
    {
        User expectedUser = new User("user", "1234", "user","jojo", 5654556);
    ...
    {
        User newUser = UserFacade.createUser("jill", "1234", "user", "jojo",5655448, connectionPool);
        User logInUser = UserFacade.login("jill", "1234", connectionPool);
        User expectedUser = new User("jill", "1234", "user","jojo",5655448);
